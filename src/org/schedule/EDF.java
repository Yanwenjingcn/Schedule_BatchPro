...
public class EDF {
	...
	public static ArrayList<DAG> dag_queue;	//按照截止时间从早到晚排序后的DAG列表
	public static ArrayList<DAG> dag_queue_ori;	//原始DAG列表
	public static ArrayList<DAG> readyqueue;	//DAG的就绪队列
	...
	public EDF(int PEnumber){
		...
		readyqueue = new ArrayList<DAG>();//就绪队列
		course_number = 0;
		current_time = 0;
